    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-sm">
        ...
        <Input
          ...
          className="pl-8 bg-card border-slate-700 text-foreground placeholder:text-muted-foreground"
        />
      </div>
          ...
          <TableBody>
            {loading ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {!search && (
                      <Button
                        ...
                        size="sm"
                        onClick={openAddForm}
                        className="mt-2 border-slate-700 text-muted-foreground hover:bg-secondary border-border"
                      >
              ...
              contacts.map((contact) => (
                <TableRow
                  key={contact.id}
                  className="border-slate-800 hover:bg-card/50 cursor-pointer"
                    ...
                    <DropdownMenu>
                      ...
                      >
                        <DropdownMenuItem
                          ...
                          className="text-muted-foreground focus:bg-secondary border-border focus:text-foreground"
                        >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              className="border-slate-700 text-muted-foreground hover:bg-secondary border-border hover:text-foreground disabled:opacity-30"
            >
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-card border-slate-700 text-foreground sm:max-w-sm">
          <DialogHeader>
