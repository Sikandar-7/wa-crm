    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <header className="sticky top-0 z-50 flex flex-shrink-0 items-center gap-2 border-b border-border bg-card/90 backdrop-blur px-3 py-3 sm:gap-3 sm:px-4 shadow-sm">
        <button
          ...
          className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-secondary border-border hover:text-foreground"
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-md bg-transparent px-2 py-1 text-sm font-semibold text-foreground placeholder:text-muted-foreground focus:bg-secondary border-border focus:outline-none sm:text-base"
        />
...
function TriggerCard({
  ...
  return (
    ...
    <div className="z-10 w-full max-w-[320px] sm:w-80">
      <div className="rounded-lg border border-slate-800 border-l-4 border-l-blue-500 bg-card shadow-lg">
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          ...
          <div className="space-y-3 border-t border-slate-800 px-4 py-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-slate-700 bg-secondary border-border px-2 py-1.5 text-sm text-foreground focus:border-primary focus:outline-none"
              >
    ...
    <div className="space-y-2">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-md border border-slate-700 bg-secondary border-border px-2 py-1.5 text-sm text-foreground focus:outline-none"
        >
  ...
  return (
    <>
      <div className={cn("z-10 flex flex-col", width)}>
        <div
          className={cn(
            "rounded-lg border border-slate-800 border-l-4 bg-card shadow-lg",
            meta.border,
          )}
        >
          <button
          ...
          >
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-md bg-secondary border-border text-muted-foreground">
        ...
        <>
          <FieldBlock label="Mode">
            <select
              ...
              className="w-full rounded-md border border-slate-700 bg-secondary border-border px-2 py-1.5 text-sm text-foreground"
            >
        ...
        <>
          ...
          <FieldBlock label="Body template (JSON)">
            <Textarea
              ...
              className="min-h-20 bg-secondary border-border font-mono text-xs text-foreground"
            />
          </FieldBlock>
        </>
      )
