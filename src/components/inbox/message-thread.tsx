...
export function MessageThread({
  ...
  if (!conversation || !contact) {
    return (
      <div className={cn("flex flex-1 flex-col items-center justify-center", DOODLE_BG_CLASSES)}>
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-secondary border-border">
  ...
  return (
    <div className={cn("flex flex-1 flex-col", DOODLE_BG_CLASSES)}>
      ...
      <div className="flex items-center justify-between gap-2 border-b border-slate-800 bg-card px-3 py-3 sm:px-4">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          {onBack && (
            <button
              ...
              className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-muted-foreground hover:bg-secondary border-border hover:text-foreground lg:hidden"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          {onRefresh && (
            <button
              ...
              title="Refresh"
              className={cn(
                "inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-secondary border-border hover:text-foreground disabled:opacity-60",
              )}
            >
              <RefreshCw
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className={cn(
                  "inline-flex items-center justify-center h-7 gap-1 px-2 text-xs rounded-md hover:bg-secondary border-border",
            ...
            <DropdownMenuContent
              align="end"
              className="border-slate-700 bg-secondary border-border"
            >
            ...
            {messageGroups.map((group) => (
              <div key={group.date}>
                ...
                <div className="mb-4 flex items-center justify-center">
                  <span className="rounded-full bg-secondary border-border px-3 py-1 text-[10px] font-medium text-muted-foreground">
