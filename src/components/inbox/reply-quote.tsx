  ...
  return (
    <div
      className={cn(
        ...
        isChip
          ? "rounded-md bg-secondary border-border/80"
    ...
    >
      ...
      {onDismiss && (
        <button
          ...
          className="flex h-6 w-6 shrink-0 items-center justify-center rounded text-muted-foreground hover:bg-slate-700 hover:text-foreground"
        >
