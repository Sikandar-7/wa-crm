...
export function PipelineAnalytics({ stages, deals }: PipelineAnalyticsProps) {
  ...
  return (
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-slate-800 bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
...
function Metric({
  ...
  return (
    <div className="rounded-lg bg-secondary border-border/50 p-3">
