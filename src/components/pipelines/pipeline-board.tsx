...
function StageColumn({
  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-slate-800 bg-card/60 p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      ...
      <div className="flex items-center justify-between pt-3">
        ...
        <span className="shrink-0 rounded-full bg-secondary border-border px-2 py-0.5 text-[11px] font-medium text-muted-foreground">
          {deals.length}
        </span>
      </div>
      ...
      >
        {deals.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg border-2 border-dashed border-slate-700 py-10 text-xs text-muted-foreground">
            Drop a deal here
          </div>
        ) : (
          deals.map((deal) => (
      ...
      <Button
        ...
        className="mt-3 w-full justify-start border border-dashed border-slate-700 bg-transparent text-muted-foreground hover:border-slate-600 hover:bg-secondary border-border hover:text-foreground"
      >
