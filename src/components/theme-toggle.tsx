...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex h-9 w-9 items-center justify-center rounded-md border border-border bg-background text-foreground hover:bg-secondary">
      ...
      <DropdownMenuContent align="end" className="bg-background text-foreground border-border">
        ...
        <DropdownMenuItem className="hover:bg-secondary" onClick={() => setTheme("dark")}>
          Dark
        </DropdownMenuItem>
