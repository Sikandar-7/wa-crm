      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-secondary border-border border-slate-700 text-foreground placeholder:text-muted-foreground"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-secondary border-border border-slate-700 text-foreground placeholder:text-muted-foreground pr-10"
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  readOnly
                  value={webhookUrl}
                  className="bg-secondary border-border border-slate-700 text-muted-foreground font-mono text-sm"
                />
                <Button
                  variant="outline"
                  size="icon"
                  onClick={handleCopyWebhookUrl}
                  className="shrink-0 border-slate-700 text-muted-foreground hover:text-foreground hover:bg-secondary border-border"
                >
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            ...
            className="border-slate-700 text-muted-foreground hover:text-foreground hover:bg-secondary border-border"
          >
            {testing ? (
              <>
                <Loader2 className="size-4 animate-spin" />
